from src.textSummariser.pipeline.stage_01_data_ingestion import DataIngestionTrainingPipeline
...
from src.textSummariser.pipeline.stage_05_model_evaluation import ModelEvaluationTrainingPipeline
